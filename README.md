...
Para uma nova rodada de teste com 1000 vértices, torna-se interessante verificar quando nossa densidade crescer muito - os testes realizados com densidades menores são similares ao do gráfico passado, para não ficar uma leitura repetitiva, consideramos remover- vemos que o Binary Heap apresenta execução maior que os outros Heaps, um tempo em torno de 10% maior. O Pairing Heap torna-se vencedor novamente devido ao overhead.
...
![gc tempo](static/new-Config-2/chart_gc_time_1500.png)
